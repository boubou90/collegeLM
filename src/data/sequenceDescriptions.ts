...
export const sequenceDescriptions: Record<string, SeqInfo[]> = {
  ...
  '3eme': [
    ...
    { emoji: '🧭', title: 'Le système de navigation',                                         desc: "Comprendre comment l'IA a transformé les objets de navigation et comment la société encadre leurs effets." },
    { emoji: '🌐', title: "Comprendre l'impact du numérique sur la société et les métiers", desc: "Analyser comment le numérique transforme la société et les métiers d'aujourd'hui et de demain." },
    { emoji: '💾', title: 'Datas : Le poids caché de nos vies numériques',                desc: 'Concevoir et modéliser des solutions techniques innovantes.' },
